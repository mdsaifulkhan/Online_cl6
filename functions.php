...
function stock_crazycafe_scripts() {
	...
	wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/boostatrap.min.js', array('jquery'), '20151215', true );

	wp_enqueue_script( 'stock-crazycafe-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
